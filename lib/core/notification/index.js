...
module.exports = class Srv {
    ...
    constructor(opts = {}) {
        ...
        Kafka.on("notification:create", this.handleNotificationCreateEvent.bind(this));
    }
     ...
     */
    async handleNotificationCreateEvent(data = {}) {
        let logger = Logger.create("handleNotificationCreateEvent", data.trackId);
