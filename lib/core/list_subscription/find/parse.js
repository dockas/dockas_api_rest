...
module.exports = class Parser {
    ...
    static parseQuery(query = {}) {
        ...
        if(query.nextDeliverDate && lodash.size(query.nextDeliverDate) > 0) {
            mquery.nextDeliverDate = {};

            lodash.forOwn(query.nextDeliverDate, (val,key) => {
                mquery.nextDeliverDate[`$${key}`] = val;
            });
        }
