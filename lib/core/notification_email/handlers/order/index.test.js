...
let Logger = new LoggerFactory("email handler order test");

describe("email handler order service", function() {
    let handler = null;
    ...
    describe("payment_authorized", function() {
        it("should send with valid data", function() {
            return handler.sendPaymentAuthorizedEmail({
    ...
    describe("status_updated", function() {
        it("should send with valid data", function() {
            return handler.sendStatusUpdatedEmail({
                to: [config.email.testTo],
                body: {
                    data: {
                        count: 233,
