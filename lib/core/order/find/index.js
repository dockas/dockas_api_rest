...
module.exports = class FindHandler {
    ...
    async find(
        ...
        try {
            ...
            records = await this.collection.find(mquery, query.select||{}).toArray();
        }
        catch(error) {
    ...
    /**
     * This function finds an entity by it's billing order id.
     */
    async findByBillingOrderId(
        ...
        // Local variables
        let record,
            logger = Logger.create("findByBillingOrderId", trackId);
