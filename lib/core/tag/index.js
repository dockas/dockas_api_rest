...
module.exports = class Srv {
    ...
    constructor(opts = {}) {
        ...
        let db = opts.db || Arango.db;
        let collection = opts.collection || "tags";

        this.createHandler = new CreateHandler({db, collection, mode});
        this.updateHandler = new UpdateHandler({db, collection, mode});
        this.findHandler = new FindHandler({db, collection, mode});
        this.removeHandler = new RemoveHandler({db, collection, mode});
